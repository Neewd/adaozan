...
export const ContactHero = () => {
	...
	return (
		<div className="flex">
			<div className="flex-1 flex flex-col items-center bg-cream-100 z-10 border-r border-brown-100 flex-col-reverse">
				<span className="self-end items-end p-12">{sentence}</span>
			</div>
