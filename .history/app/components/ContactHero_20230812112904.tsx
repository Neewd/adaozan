					...
					{networks.map((network, index) => {
						return (
							<motion.a
								...
								style={
									{
										"--border-left-width": hovered
											? "10px"
											: "0", // This is your CSS variable
									} as any
								}
								initial={
									{ "--border-left-width": "0px" } as any
								} // Initial state
								animate={
									{
										"--border-left-width": hovered
								...
								} // Animate to the desired values
								className={classNames(
									"p-12 bg-cream-100 z-10 border-b border-brown-100 text-xl font-bold font-heading text-brown-100 cursor-pointer border-l [border-left-width:var(--border-left-width, 0)]",
									{
										"border-none":
