	...
	return (
		<div className="flex">
			<div className="flex-1 flex items-center bg-cream-100 z-10 border-r border-brown-100 flex-col-reverse">
				<span className="self-end items-end p-12 text-brown-100 text-2xl">
					{sentence}
				</span>
			</div>
					...
					return (
						<a
							...
							className={classNames(
								"p-12 bg-cream-100 z-10 border-b border-brown-100 text-4xl font-bold font-heading text-brown-100 cursor-pointer",
								{
									"border-none":
