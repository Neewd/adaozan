...
export const ContactHero = () => {
	...
	return (
		<>
			...
			<div className="flex text-brown-100 text-xl font-bold font-heading bg-cream-100">
				<div className="flex py-4 px-12 flex-1 border-r border-brown-100 bg-cream-100">
					Crédits
				</div>
