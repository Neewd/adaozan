	...
	return (
		<>
			<div className="w-full bg-brown-100 relative h-min min-h-full">
				<div className="hidden sm:flex sm:flex-row flex-col top-0 sticky w-full z-1 h-[20vh]">
				...
				<div className="flex sm:flex-row flex-col border-b border-r-brown-100 bg-cream-100 relative text-brown-100 font-heading">
					<div className="flex flex-1 border-b sm:border-r border-brown-100 p-6 flex-col">
