        ...
        <div className="flex flex-col border-b border-r-brown-100 bg-cream-100 relative text-brown-100 font-heading">
          <div className="flex flex-1 border-b border-brown-100 p-6 flex-col">
            ...
            <p className="py-2">
              ...
              d’aménagement valorisant les déchets de pommes, dont la liste des
              produits vendus dans la limite des stocks disponibles est
            ...
            <p className="py-2">
              Les livraisons sont faites à l’adresse indiquée par le client. Les
              délais de livraison ne sont donnés qu’à titre indicatif ; si
              ceux-ci dépassent trente jours à compter de la commande, le
              contrat de vente pourra être résilié et le client remboursé.
              Adaozan SAS pourra fournir sur demande au client le numéro de
              suivi de son colis. Le client est livré à son domicile ou en point
              relais par le livreur choisi par Adaozan SAS. Les risques liés au
              transport sont à la charge du client à compter du moment où les
              articles quittent les locaux d’Adaozan SAS. Le client est tenu de
              vérifier en présence du livreur, l’état de l’emballage de la
              marchandise et son contenu à la livraison. En cas de dommage
              pendant le transport, toute protestation doit être effectuée
              auprès du transporteur dans un délai de trois jours à compter de
              la livraison.
            </p>

            <h3 className="pt-2 font-bold">4- Modalités de paiement</h3>
            <p className="py-2">
              L'intégralité du paiement doit être réalisé lors de la commande,
              par virement bancaire ou par chèque. Adaozan SAS conserve la
              propriété de l'article jusqu'au paiement intégral du prix par le
              client.
            </p>
            ...
            <p className="py-2">
              ...
              client dispose d'un délai de quatorze jours ouvrables à compter de
              la livraison de leur commande pour exercer son droit de
            ...
            <p className="py-2">
              ...
              civil. En cas de non-conformité d’un produit vendu, il pourra être
              retourné à Adaozan SAS qui le reprendra, l’échangera ou le
              remboursera. Toutes les réclamations, demandes d’échange ou de
              remboursement doivent s’effectuer par voie électronique à
              l’adresse suivante : contact@adaozan.fr dans un délai de quatorze
              jours après livraison.
            </p>

            <h3 className="pt-2 font-bold">7- Service après-vente</h3>
            <p className="py-2">
              La communication à distance avec le service après-vente n’entraine
            ...
            <p className="py-2">
              ...
              l’exécution de la commande dans les cas de force majeure, tels
              qu’ils sont définis par la jurisprudence, ainsi que dans le cas
              d’évènements caractérisés entraînant une impossibilité d’exécution
              tels que grèves, confinements, incendies, inondations, gels,
          ...
          <div className="flex">
            <div className="flex flex-1 p-6 flex-col border-r border-brown-100">
              ...
              <p>
                ...
                pouvant conduire à des poursuites (articles L.335-2 et suivants
            ...
            <div className="flex flex-1 flex-col border-r border-brown-100 p-6 ">
              ...
              <p>
                ...
                n° 78-17 du 6 janvier 1978. A ce titre, l'internaute dispose
                d'un droit d'accès, de modification et de suppression des
                informations le concernant. Il peut en faire la demande à tout
                moment par mail à l’adresse suivante : contact@adaozan.fr
              </p>
            </div>
            <div className="flex flex-1 flex-col p-6">
              <h2 className="font-bold mb-4">RESPONSABILITÉ</h2>
              <p>
                Dans le processus de vente à distance, Adaozan SAS n’est tenu
                que par une obligation de moyens. La responsabilité d’Adaozan
                SAS ne saurait être engagée pour tous les inconvénients ou
                dommages inhérents à l’utilisation du réseau internet, notamment
                une rupture de service, une intrusion extérieure ou la présence
                de virus informatiques, ou de tout fait qualifié de force
                majeure, conformément à la loi et à la jurisprudence.
              </p>
            </div>
          </div>
        </div>
